...
get data /type = txt
/file = 'U:\Data\EX\z_external_data\IPEDS_Completions\2012_13\Provisional\c2012_a.csv' 
/delcase = line
/delimiters = ","
/qualifier =  '"' 
...
cdistedp  'Program offered as a distance education program'
...
xcaiant  'Imputation field for caiant - American Indian or Alaska Native total'
caiant   'American Indian or Alaska Native total' 
xcaianm  'Imputation field for caianm - American Indian or Alaska Native men'
caianm   'American Indian or Alaska Native men' 
xcaianw  'Imputation field for caianw - American Indian or Alaska Native women'
caianw   'American Indian or Alaska Native women' 
xcasiat  'Imputation field for casiat - Asian total'
casiat   'Asian total' 
xcasiam  'Imputation field for casiam - Asian men'
casiam   'Asian men' 
xcasiaw  'Imputation field for casiaw - Asian women'
casiaw   'Asian women' 
xcbkaat  'Imputation field for cbkaat - Black or African American total'
cbkaat   'Black or African American total' 
xcbkaam  'Imputation field for cbkaam - Black or African American men'
cbkaam   'Black or African American men' 
xcbkaaw  'Imputation field for cbkaaw - Black or African American women'
cbkaaw   'Black or African American women' 
xchispt  'Imputation field for chispt - Hispanic or Latino total'
chispt   'Hispanic or Latino total' 
xchispm  'Imputation field for chispm - Hispanic or Latino men'
chispm   'Hispanic or Latino men' 
xchispw  'Imputation field for chispw - Hispanic or Latino women'
chispw   'Hispanic or Latino women' 
xcnhpit  'Imputation field for cnhpit - Native Hawaiian or Other Pacific Islander total'
cnhpit   'Native Hawaiian or Other Pacific Islander total' 
xcnhpim  'Imputation field for cnhpim - Native Hawaiian or Other Pacific Islander men'
cnhpim   'Native Hawaiian or Other Pacific Islander men' 
xcnhpiw  'Imputation field for cnhpiw - Native Hawaiian or Other Pacific Islander women'
cnhpiw   'Native Hawaiian or Other Pacific Islander women' 
xcwhitt  'Imputation field for cwhitt - White total'
cwhitt   'White total' 
xcwhitm  'Imputation field for cwhitm - White men'
cwhitm   'White men' 
xcwhitw  'Imputation field for cwhitw - White women'
cwhitw   'White women' 
xc2mort  'Imputation field for c2mort - Two or more races total'
c2mort   'Two or more races total' 
xc2morm  'Imputation field for c2morm - Two or more races men'
c2morm   'Two or more races men' 
xc2morw  'Imputation field for c2morw - Two or more races women'
...
5 'Bachelor^s degree' 
7 'Master^s degree' 
17 'Doctor^s degree - research/scholarship (new degree classification)' 
18 'Doctor^s degree - professional practice (new degree classification)' 
19 'Doctor^s degree - other (new degree classification)' 
...
1 'Yes'
2 'No'
-2 'Not applicable grand total cip(99)'.
...
cipcode  majornum awlevel cdistedp xctotalt xctotalm xctotalw xcaiant  xcaianm  xcaianw 
xcasiat  xcasiam  xcasiaw  xcbkaat  xcbkaam  xcbkaaw  xchispt  xchispm  xchispw  xcnhpit 
xcnhpim  xcnhpiw  xcwhitt  xcwhitm  xcwhitw  xc2mort  xc2morm  xc2morw  xcunknt  xcunknm 
xcunknw  xcnralt  xcnralm  xcnralw  .

descriptives variables=
ctotalt  ctotalm  ctotalw  caiant   caianm   caianw  
casiat   casiam   casiaw   cbkaat   cbkaam   cbkaaw   chispt   chispm   chispw   cnhpit  
cnhpim   cnhpiw   cwhitt   cwhitm   cwhitw   c2mort   c2morm   c2morw   cunknt   cunknm  
cunknw   cnralt   cnralm   cnralw  
/stats=def.

save outfile='U:\Data\EX\z_external_data\IPEDS_Completions\2012_13\Provisional\c2012_a.sav' /compressed.
