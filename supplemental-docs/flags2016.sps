...
stat_c   'Response status -  Completions' 
...
hasal    'Has academic library (access to library collection and/or has library expenses)' 
...
rev_gr   'Revision status - Graduation Rates' 
rev_gr2  'Revision status - Graduation Rates 200' 
rev_om   'Revision status - Outcome Measures' 
rev_adm  'Revision status - Admissions' 
rev_hr   'Revision status - Human Resources' 
rev_ef   'Revision status - Fall Enrollment' 
rev_f    'Revision status - Finance' 
rev_al   'Revision status - Academic Libraries'.
...
1 'Parent record - includes data from branch campuses' 
2 'Child record - data reported with parent campus' 
3 'Partial child record - reports revenues/expenses and assets/liabilities reported with parent campus' 
...
hasal    ntrldstr rev_ic   rev_c    rev_e12  rev_sfa  rev_gr   rev_gr2  rev_om   rev_adm 
rev_hr   rev_ef   rev_f    rev_al   .
...
save outfile='flags2016_dist.sav' /compressed.
