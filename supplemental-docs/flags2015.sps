...
omflg1gr 'OM flag 1 - inconsistent data with full-time first-time cohort, 2-year institutions' 
omflg2gr 'OM flag 2 - inconsistent data with bachelor^s cohort, 4-year institutions' 
omflg3gr 'OM flag 3 - inconsistent data with full-time first-time cohort, 4-year institutions' 
omflg4   'OM flag 4 - no completers data reported' 
omflg5   'OM flag 5 - no transfer-out data  reported' 
omflg6gr 'OM flag 6 - inconsistent  first-time, full-time transfer-out data'.
...
'102014'  'October 2014' 
'112014'  'November 2014' 
'122014'  'December 2014' 
'-1'  'Not reported' 
'-2'  'Not applicable' 
/fyend     
'022014'  'February 2014' 
...
1 'Submitted revised data' 
0 'Did not submit revised data' 
-2 'Not applicable, revised OM data not released' 
/rev_adm   
1 'Submitted revised data' 
0 'Did not submit revised data' 
-2 'Not applicable' 
...
/omflg4    
0 'No issues' 
1 'No completers data reported' 
-2 'Not applicable' 
/omflg5    
0 'No issues' 
1 'No transfer-out data reported' 
-2 'Not applicable' 
/omflg6gr  
0 'No issues' 
1 'Data inconsistencies' 
...
prch_f   imp_f    form_f   fybeg    fyend    gpfs     f1gasbal f2pell  
f3pell   f_athltc f3bist   stat_al  lock_al  prch_al  imp_al   hasal   
ntrldstr rev_ic   rev_c    rev_e12  rev_sfa  rev_gr   rev_gr2  rev_om   rev_adm  rev_hr  
rev_ef   rev_f    rev_al   omflg1gr omflg2gr omflg3gr omflg4   omflg5   omflg6gr .
...
save outfile='flags2015_dist.sav' /compressed.
