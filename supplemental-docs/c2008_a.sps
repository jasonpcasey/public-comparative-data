...
get data  /type = txt
/file = 'Q:\storage\external_data\IPEDS_Completions\2007_08\c2008_a.csv'
/delcase = line
/delimiters = ","
/qualifier = '"'
...
xcnralm 'Imputation field for CNRALM - Nonresident alien men'
cnralm 'Nonresident alien men'
xcnralw 'Imputation field for CNRALW - Nonresident alien women'
cnralw 'Nonresident alien women'
xcrace03 'Imputation field for CRACE03 - Black non-Hispanic men - old'
crace03 'Black non-Hispanic men - old'
xcrace04 'Imputation field for CRACE04 - Black non-Hispanic women - old'
crace04 'Black non-Hispanic women - old'
xcrace05 'Imputation field for CRACE05 - American Indian or Alaska Native men - old'
crace05 'American Indian or Alaska Native men - old'
xcrace06 'Imputation field for CRACE06 - American Indian or Alaska Native women - old'
crace06 'American Indian or Alaska Native women - old'
xcrace07 'Imputation field for CRACE07 - Asian or Pacific Islander men - old'
crace07 'Asian or Pacific Islander men - old'
xcrace08 'Imputation field for CRACE08 - Asian or Pacific Islander women - old'
crace08 'Asian or Pacific Islander women - old'
xcrace09 'Imputation field for CRACE09 - Hispanic men - old'
crace09 'Hispanic men - old'
xcrace10 'Imputation field for CRACE10 - Hispanic women - old'
crace10 'Hispanic women - old'
xcrace11 'Imputation field for CRACE11 - White non-Hispanic men - old'
crace11 'White non-Hispanic men - old'
xcrace12 'Imputation field for CRACE12 - White non-Hispanic women - old'
crace12 'White non-Hispanic women - old'
xcunknm 'Imputation field for  -'
cunknm 'Race/ethnicity unknown men'
xcunknw 'Imputation field for  -'
cunknw 'Race/ethnicity unknown women'
xctotalm 'Imputation field for CTOTALM - Grand total men'
ctotalm 'Grand total men'
xctotalw 'Imputation field for CTOTALW - Grand total women'
ctotalw 'Grand total women'
xcnralt 'Imputation field for CNRALT - Nonresident alien total'
cnralt 'Nonresident alien total'
xcrace18 'Imputation field for CRACE18 - Black non-Hispanic  total - old'
crace18 'Black non-Hispanic  total - old'
xcrace19 'Imputation field for CRACE19 - American Indian or Alaska Native total - old'
crace19 'American Indian or Alaska Native total - old'
xcrace20 'Imputation field for CRACE20 - Asian or Pacific Islander total - old'
crace20 'Asian or Pacific Islander total - old'
xcrace21 'Imputation field for CRACE21 - Hispanic total - old'
crace21 'Hispanic total - old'
xcrace22 'Imputation field for CRACE22 - White non-Hispanic total - old'
crace22 'White non-Hispanic total - old'
xcunknt 'Imputation field for CUNKNT - Race/ethnicity unknown total'
cunknt 'Race/ethnicity unknown total'
xctotalt 'Imputation field for CTOTALT - Grand total'
ctotalt 'Grand total'
xchispm 'Imputation field for CHISPM - Hispanic or Latino men - new'
chispm 'Hispanic or Latino men - new'
xchispw 'Imputation field for CHISPW - Hispanic or Latino women - new'
chispw 'Hispanic or Latino women - new'
xcaianm 'Imputation field for CAIANM - American Indian or Alaska Native men - new'
caianm 'American Indian or Alaska Native men - new'
xcaianw 'Imputation field for CAIANW - American Indian or Alaska Native women - new'
caianw 'American Indian or Alaska Native women - new'
xcasiam 'Imputation field for CASIAM - Asian men - new'
casiam 'Asian men - new'
xcasiaw 'Imputation field for CASIAW - Asian women - new'
casiaw 'Asian women - new'
xcbkaam 'Imputation field for CBKAAM - Black or African American men - new'
cbkaam 'Black or African American men - new'
xcbkaaw 'Imputation field for CBKAAW - Black or African American women - new'
cbkaaw 'Black or African American women - new'
xcnhpim 'Imputation field for CNHPIM - Native Hawaiian or Other Pacific Islander men - new'
cnhpim 'Native Hawaiian or Other Pacific Islander men - new'
xcnhpiw 'Imputation field for CNHPIW - Native Hawaiian or Other Pacific Islander women - new'
cnhpiw 'Native Hawaiian or Other Pacific Islander women - new'
xcwhitm 'Imputation field for CWHITM - White men - new'
cwhitm 'White men - new'
xcwhitw 'Imputation field for CWHITW - White women - new'
cwhitw 'White women - new'
xc2morm 'Imputation field for C2MORM - Two or more races men - new'
c2morm 'Two or more races men - new'
xc2morw 'Imputation field for C2MORW - Two or more races women - new'
c2morw 'Two or more races women - new'
xchispt 'Imputation field for CHISPT - Hispanic or Latino total - new'
chispt 'Hispanic or Latino total - new'
xcaiant 'Imputation field for CAIANT - American Indian or Alaska Native total - new'
caiant 'American Indian or Alaska Native total - new'
xcasiat 'Imputation field for CASIAT - Asian total - new'
casiat 'Asian total - new'
xcbkaat 'Imputation field for CBKAAT - Black or African American total - new'
cbkaat 'Black or African American total - new'
xcnhpit 'Imputation field for CNHPIT - Native Hawaiian or Other Pacific Islander total - new'
cnhpit 'Native Hawaiian or Other Pacific Islander total - new'
xcwhitt 'Imputation field for CWHITT - White total - new'
cwhitt 'White total - new'
xc2mort 'Imputation field for C2MORT - Two or more races total - new'
c2mort 'Two or more races total - new'
xdvcait 'Imputation field for DVCAIT - American Indian or Alaska Native total - derived'
dvcait 'American Indian or Alaska Native total - derived'
xdvcaim 'Imputation field for DVCAIM - American Indian or Alaska Native men - derived'
dvcaim 'American Indian or Alaska Native men - derived'
xdvcaiw 'Imputation field for DVCAIW - American Indian or Alaska Native women - derived'
dvcaiw 'American Indian or Alaska Native women - derived'
xdvcapt 'Imputation field for DVCAPT - Asian/Native Hawaiian/Other Pacific Islander total - derived'
dvcapt 'Asian/Native Hawaiian/Other Pacific Islander total - derived'
xdvcapm 'Imputation field for DVCAPM - Asian/Native Hawaiian/Other Pacific Islander men - derived'
dvcapm 'Asian/Native Hawaiian/Other Pacific Islander men - derived'
xdvcapw 'Imputation field for DVCAPW - Asian/Native Hawaiian/Other Pacific Islander women - derived'
dvcapw 'Asian/Native Hawaiian/Other Pacific Islander women - derived'
xdvcbkt 'Imputation field for DVCBKT - Black or African American/Black non-Hispanic total - derived'
dvcbkt 'Black or African American/Black non-Hispanic total - derived'
xdvcbkm 'Imputation field for DVCBKM - Black or African American/Black non-Hispanic men - derived'
dvcbkm 'Black or African American/Black non-Hispanic men - derived'
xdvcbkw 'Imputation field for DVCBKW - Black or African American/Black non-Hispanic women - derived'
dvcbkw 'Black or African American/Black non-Hispanic women - derived'
xdvchst 'Imputation field for DVCHST - Hispanic or Latino/Hispanic total - derived'
dvchst 'Hispanic or Latino/Hispanic total - derived'
xdvchsm 'Imputation field for DVCHSM - Hispanic or Latino/Hispanic men - derived'
dvchsm 'Hispanic or Latino/Hispanic men - derived'
xdvchsw 'Imputation field for DVCHSW - Hispanic or Latino/Hispanic women - derived'
dvchsw 'Hispanic or Latino/Hispanic women - derived'
xdvcwht 'Imputation field for DVCWHT - White/White non-Hispanic total - derived'
dvcwht 'White/White non-Hispanic total - derived'
xdvcwhm 'Imputation field for DVCWHM - White/White non-Hispanic men - derived'
dvcwhm 'White/White non-Hispanic men - derived'
xdvcwhw 'Imputation field for DVCWHW - White/White non-Hispanic women - derived'
dvcwhw 'White/White non-Hispanic women - derived'.
...
'42.05' 'Comparitive Psychology'
'42.0501' 'Comparitive Psychology'
...
'95.95' 'Undesignated field of study'
'95.9500' 'Undesignated field of study'
'99' 'Grand total'
/majornum 1 'First major'
2 'Second major'
/awlevel 1 'Award of less than 1 academic year'
10 'First-professional degree (old degree classification)'
11 'First-professional certificate (old degree classification)'
12 'Degrees total'
13 'Certificates below the baccalaureate total'
14 'Certificates above the baccalaureate total'
15 'Degrees/certificates total'
17 'Doctors degree - research/scholarship (new degree classification)'
18 'Doctors degree - professional practice (new degree classification)'
19 'Doctors degree - other (new degree classification)'
...
9 'Doctors degree (old degree classification)'
/xcnralm 'A' 'Not applicable'
...
frequencies variables=
     cipcode majornum awlevel xcnralm xcnralw xcrace03 xcrace04 xcrace05 xcrace06 
     xcrace07 xcrace08 xcrace09 xcrace10 xcrace11 xcrace12 xcunknm xcunknw xctotalm 
     xctotalw xcnralt xcrace18 xcrace19 xcrace20 xcrace21 xcrace22 xcunknt xctotalt 
     xchispm xchispw xcaianm xcaianw xcasiam xcasiaw xcbkaam xcbkaaw xcnhpim 
     xcnhpiw xcwhitm xcwhitw xc2morm xc2morw xchispt xcaiant xcasiat xcbkaat xcnhpit 
     xcwhitt xc2mort xdvcait xdvcaim xdvcaiw xdvcapt xdvcapm xdvcapw xdvcbkt xdvcbkm 
     xdvcbkw xdvchst xdvchsm xdvchsw xdvcwht xdvcwhm xdvcwhw.

descriptives variables= cnralm cnralw crace03 crace04 crace05 crace06 crace07 
     crace08 crace09 crace10 crace11 crace12 cunknm cunknw ctotalm ctotalw cnralt 
     crace18 crace19 crace20 crace21 crace22 cunknt ctotalt chispm chispw caianm 
     caianw casiam casiaw cbkaam cbkaaw cnhpim cnhpiw cwhitm cwhitw c2morm 
     c2morw chispt caiant casiat cbkaat cnhpit cwhitt c2mort dvcait dvcaim dvcaiw 
     dvcapt dvcapm dvcapw dvcbkt dvcbkm dvcbkw dvchst dvchsm dvchsw dvcwht 
     dvcwhm dvcwhw
     /STATISTICS = DEFAULT.

save outfile='Q:\storage\external_data\IPEDS_Completions\2007_08\c2008_a.sav' /compressed.
