...
15 'Institution not in 1998-99 IPEDS universe'
...
4 'Mailed, Part E nonresponse, imputed'
/prch_ic -2 '{Item not applicable}'
1 'Parent record (combined data)'
2 'Child record (reported with parent)'
/imp_ic -2 'not applicable, not imputed'
1 'Imputed using current year mean average'
2 'Imputed using prior year data'
...
3 'Edit flags remain, NCES accepted'
...
7 'Private, nonprofit, other religious affiliat'
/hloffer -2 '{Item not applicable}'
0 'Other'
...
save outfile='ic98hdac.sav' /compressed.
